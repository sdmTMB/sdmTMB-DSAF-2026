...
* Design-based methods (e.g., stratified means) are straightforward but assume perfect survey implementation
...
3. Sum up the density multiplied by cell area to calculate total abundance or biomass: .blue[`get_index()`] (a grid-based approximation of the integral)
...
```{r, echo=FALSE}
grid <- replicate_df(qcs_grid, "year", time_values = unique(pcod$year))
```
...
Yalcin, S., Anderson, S.C., Regular, P.M., and English, P.A. 2023. Exploring the limits of spatiotemporal and design-based index standardization under reduced survey coverage. ICES Journal of Marine Science 80(9): 2368–2379. <https://doi.org/10.1093/icesjms/fsad155>
]

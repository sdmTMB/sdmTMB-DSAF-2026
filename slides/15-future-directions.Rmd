...
Thus far has we've intentionally kept this as an intention difference between sdmTMB/VAST/tinyVAST
...
Decorrelate the posterior using the joint precision matrix from TMB

~30x faster for sdmTMB models
...
A better understanding of how to best combine survey data without explicit calibration

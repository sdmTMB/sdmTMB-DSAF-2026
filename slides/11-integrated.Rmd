...
Using different likelihoods per row of data isn't merged into the main branch of sdmTMB yet, but should be soon. See the [multiple-data](https://github.com/sdmTMB/sdmTMB/tree/multiple-data) branch and [this vignette](https://github.com/sdmTMB/sdmTMB/blob/multiple-data/vignettes/articles/multi-family.Rmd). It's possible in tinyVAST.

...
Day 2: Families, delta models, time-varying effects, spatially varying effects, index standardization, metrics of distribution change

--

Day 3: Integrated models, forecasting, simulating
...
Have questions? Please ask any time or in the [Google Doc](https://docs.google.com/document/d/19zveT73HVWa73UhxsAcDntAhrBDX_F327otqve7RQ4Y/edit?usp=sharing). Thanks!
...
Management and conservation is aided by understanding how distributions are changing and may change in the future
...
.large[
1. Fit a spatially explicit model

2. Predict to a constant grid
(standardizes for spatial variation in sampling)
...
.large[
To calculate distribution metrics reliably, we need to understand how to properly fit models to large spatiotemporal survey datasets.

How do we handle these data?
]
...
.tiny[
Renner, I.W., Elith, J., Baddeley, A., Fithian, W., Hastie, T., Phillips, S.J., Popovic, G., and Warton, D.I. 2015. Point process models for presence‐only analysis. Methods Ecol Evol 6(4): 366–379.
]

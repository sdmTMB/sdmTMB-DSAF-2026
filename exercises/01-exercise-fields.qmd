...
-   The two important standard deviation parameters are `sigma_O` (controlling the marginal standard deviation of `omega_s`, the spatial random field values) and `phi` (controlling the observation error standard deviation).

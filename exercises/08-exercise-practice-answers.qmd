---
title: "Fitting spatiotemporal models + distribution metrics practice"
format: html
editor: visual
execute:
  echo: true
...
Try calculating an index for the northern half of Queen Charlotte Sound (\> 5725 UTMs) and the souther half (\<= 5725 UTMs).
...
index_north <- get_index(pred_north, area = 4, bias_correct = TRUE) # answer
index_south <- get_index(pred_south, area = 4, bias_correct = TRUE) # answer
